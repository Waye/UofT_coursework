...
/**
 * This is Logging class The logging class handle image save problem so that all information will be
 * store after application exit.
 */
    ...
    if (handlerSwitch) {
      ...
      try {
        FileHandler fileHandler =
            new FileHandler(System.getProperty("user.dir") + "/config/NamingLogFile.log", true);
